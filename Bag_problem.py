...
print(f"Набор предметов для задачи в семь ячеек:{get_tools_list(toolsdict,7)}")
print("Т.е. эта та же матрица выше, но без элемента 'd'\nТогда очков выживания всего 10")
